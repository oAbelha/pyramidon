            ...
            <v-window v-model="window">
              <v-window-item value="1" class="justify-center">
                <v-col>
                  ...
                  <v-text-field v-model="password" label="Senha" prepend-icon="mdi-lock" :type="show1 ? 'password' : 'text'" :append-inner-icon="show1 ? 'mdi-eye-off' : 'mdi-eye'" @click:append-inner="show1 = !show1" />
                  <v-text-field v-model="confirmPassword" label="Confirmar Senha" prepend-icon="mdi-lock-check" :type="show2 ? 'password' : 'text'" :append-inner-icon="show2 ? 'mdi-eye-off' : 'mdi-eye'" @click:append-inner="show2 = !show2" />
